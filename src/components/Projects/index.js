    ...
    return (
        <section id='projects' >
            ...
            <div className='project-container'>
                ...
                <img src={project_2} alt='Vitor Bigelli | vitorbigelli | DeepWild' className='shadow'/> 
            ...
            <div className='project-container'>
                ...
                <img src={project_1}  alt='Vitor Bigelli | vitorbigelli | DeepWild' className='shadow'/>
            ...
            <div className='project-container'>
                <h2> My Reads</h2>
                <img src={project_4}  alt='Vitor Bigelli | vitorbigelli | My Reads' className='shadow'/>
            ...
            <div className='project-container'>
                <h2> GuessMTG Wordle</h2>
                <img src={project_5}  alt='Vitor Bigelli | vitorbigelli | My Reads' className='shadow'/>
